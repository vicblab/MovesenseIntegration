...
#endif
{
	...
	[Serializable]
	public sealed class IMU6Args : EventArgs
	{
		public MeasurementValues[] Gyro { get; private set; }
		public MeasurementValues[] Acc { get; private set; }
		public IMU6Args(string serial, string type, string data, MeasurementValues[] gyro, MeasurementValues[] acc) : base(serial, type, data)
		{
			Acc = acc;
			Gyro = gyro;
		}
...
#pragma warning restore CS0162
		...
		else if (subscriptionPath == SubscriptionPath.IMU6)
		{
			eventArgs = new IMU6Args(serial, subscriptionPath, data, notification.Body.ArrayGyro, notification.Body.ArrayAcc);
		}
		else
		{
			// for custom paths
